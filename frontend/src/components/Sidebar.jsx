      ...
      <div className="flex h-full min-h-[700px] flex-col justify-between bg-[#111418] p-4">
        <div className="flex flex-col gap-4">
          <Link to="/" className="hover:opacity-80 transition-opacity">
            <h1 className="text-white text-base font-medium leading-normal">JustScan</h1>
          </Link>
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <p className="text-white text-sm font-medium leading-normal">Scan</p>
            </Link>
            <Link 
              to="/assistant" 
              className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${
            ...
            >
              ...
              <p className="text-white text-sm font-medium leading-normal">AI Assistant</p>
            </Link>
            <Link 
              to="/notes" 
              className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${
            ...
            >
              <div className="text-white" data-icon="Note" data-size="24px" data-weight="regular">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                  <path
              ...
              <p className="text-white text-sm font-medium leading-normal">Notes</p>
            </Link>
          </div>
        </div>
